...
export default function PersonCard ({ avatar_url, name, role }:Props) {
    return <div className={'p-default_spacing rounded-lg bg-hover flex flex-col gap-default_spacing min-w-[160px] text-white'}>
        <div className={'h-40 rounded-lg relative overflow-hidden'}>
            <Image src={avatar_url || '/assets/img/avatar.webp'} alt={name} fill className={'absolute'} />
        </div>
