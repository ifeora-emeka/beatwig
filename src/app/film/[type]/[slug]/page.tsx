...
export default async function Page(props: any) {
    ...
    return (
        <div className={"flex justify-center gap-default_spacing py-default_spacing_xl px-2"}>
            <ContainerLg>
                <div className={'flex flex-col gap-default_spacing'}>
                    <FilmHero data={res.data.result} />
                    <div className={'flex gap-default_spacing lg:flex-row flex-col-reverse'}>
                        <FilmDetailsLeft data={res.data.result} />
                        <div className={'flex-1 p-default_spacing bg-card rounded-lg text-white'}>
                            <PageSection Icon={BiInfoCircle} heading={"More info"}>
                                <div>
                    ...
                    <FilmRecommendations data={res.data.result.recommendations} />
                </div>
            </ContainerLg>
        </div>
    );
